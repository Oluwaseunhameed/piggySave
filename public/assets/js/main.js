...
(function ($) {
    ...
    var piggysave = {
        ...
        sliderActivations: {
            ...
            init: function () {
                piggysave.sliderActivations.heroSliderActivation();
                piggysave.sliderActivations.heroSliderActivation2();
                piggysave.sliderActivations.featureSliderActivation();
                piggysave.sliderActivations.testimonialSliderActivation();
                piggysave.sliderActivations.testimonialSlider2Activation();
                piggysave.sliderActivations.productVerticalSliderActivation();
                piggysave.sliderActivations.blogSliderActivation();
                piggysave.sliderActivations.brandlogoSliderActivation();
                piggysave.sliderActivations.portfolioGallerySliderActivation();
                piggysave.sliderActivations.blogGallerySliderActivation();
                piggysave.sliderActivations.productDetailsImageSlider();
                piggysave.sliderActivations.similliarProductSlider();
            }
        ...
        popupActivation: {
            ...
            init: function () {
                piggysave.popupActivation.videoPopup();
                piggysave.popupActivation.portfolioImagePopup();
                piggysave.popupActivation.portfolioDetailsImagePopup();
                piggysave.popupActivation.productDetailsImageZoom();
            }
        },
        ...
        /* Initializer */
        init: function () {
            piggysave.meanmenuActivation();
            piggysave.dataBgImage();
            piggysave.haderSearchForm();
            piggysave.herosliderHeight();
            piggysave.buttonEffect();
            piggysave.sliderActivations.init();
            piggysave.countdownActivation();
            piggysave.counterupActivation();
            piggysave.wowJsActive();
            piggysave.priceboxActiveState();
            piggysave.blogHoverState();
            piggysave.blogSocialAction();
            piggysave.stickySidebarActive();
            piggysave.popupActivation.init();
            piggysave.portfolioFilter();
            piggysave.blogMasonryActive();
            piggysave.rangeSlider();
            piggysave.niceSelectActive();
            piggysave.productDetailsZoom();
            piggysave.productQuantityBox();
            piggysave.productDetailsImageZoomChange();
            piggysave.productDetailsColorSize();
            piggysave.productRatingInput();
            piggysave.differentAddressFormToggle();
            piggysave.checkoutPaymentMethod();
            piggysave.scrollUpActive();
            piggysave.modalSlickConflict();
            piggysave.stickyHeader();
            piggysave.parallaxActive();
            piggysave.videoBackgroundActive();
            piggysave.ajaxMailchimp();
            piggysave.menuOverflow();
            piggysave.particleJsActive();
            piggysave.rippleJsActive();
            piggysave.animatedHeadline();
            piggysave.scrollToSection();
            piggysave.scrollSpyActive();
        }
    };
